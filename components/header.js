    ...
    <header className="bg-[#ff5200] font-serif">
      ...
      <div className="pt-16 pb-8 relative">
                ...
                <div className="max-w-[70%] container mx-auto flex gap-5 mt-10">
                 <input className="bg-white w-[40%] text-xl px-6 py-4 rounded-2xl outline-none" placeholder="Delhi, India"></input>
                 <input className="bg-white w-[55%] text-xl px-6 py-4 rounded-2xl outline-none" placeholder="Search for restaurant and items for more"></input>
                </div>
            </div>
      {/* third div  */}
